...
1. les [[qn][questions]], qui se terminent par un point d'interrogation ;
2. les [[ntn][notions]], qui ne forment pas des phrases complètes ;
3. les [[ctn][citations]], qui contiennent des guillemets.


** <<qn>> Question

Les questions se subdivisent en deux grandes catégories :

1. les [[qnTot][questions totales]] sont celles qui /demandent une décision/,
   c'est-à-dire une réponse par oui ou non ;
2. les [[qnPart][questions partielles]] sont celles qui /demandent une précision/,
   qui peut prendre la forme d'un groupe nominal ou d'un complément
   circonstanciel : elles contiennent un mot ou une expression
   interrogatifs comme « qui », « que », « à qui », « de quoi »,
   « à quoi bon », « pourquoi », « comment », « à quelles conditions »,
...
On trouvera ici la liste des questions totales, c'est-à-dire appelant
une décision par oui ou non.

Parmi les questions totales, deux catégories méritent une attention
particulière :

1. les [[qnTotQuant][questions /quantifiées/]], qui contiennent les mots « tous »,
   « existe-t-il », « y a-t-il », « toujours », « jamais », « parfois »,
   « partout », « nulle part », « quelque part », etc.
2. les [[qnTotMod][questions /modales/]], qui contiennent les mots « faut-il »,
   « doit-on », « peut-on », « nécessaire », « possible »,
   « obligatoire », « interdit », « autorisé », « permis », etc.
...
Les citations sont les sujets comportant des guillemets.
